        ...
        <div className="space-y-6 pb-12 animate-in fade-in">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 text-white shadow-xl">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        <h1 className="text-4xl font-black mb-2 text-keeta-primary tracking-tight">Vendor Comparison</h1>
                        <p className="text-slate-400 font-medium">Side-by-side performance analysis & rankings</p>
                    </div>

                    {/* Period Selector */}
                    <div className="flex items-center gap-3 bg-white/10 p-2 rounded-2xl border border-white/10 backdrop-blur-sm">
